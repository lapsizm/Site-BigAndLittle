class ImageUploadHelper:
    ...
    @classmethod
    def get_field_to_combine_and_upload_postfix(cls,klass):  #klass - Product(название модели)
    ...
    @property  #обычный геттер, чтобы отделить свойства класса от метода, вызывается без скобок
    def path(self):
